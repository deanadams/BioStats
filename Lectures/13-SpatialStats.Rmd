...
where $\small{r}$ describes the expected covariance (correlation) between a pair of subjects, and $\small{d}$ is the distance between them over which this correlation decays. 
