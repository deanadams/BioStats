...
Here the averaged model attains a **WORSE** AIC than the models from which it was averaged! This makes not sense, as the point of model averaging is to arrive at a *Better* model than those in the candidate set!
