...
*Many* other distance measures exist for continuous variables (Manhattan distance, Mahalanobis distane, Canberra distance, etc.)
...
- Adjust covariance matrix (via generalized inverse, shrinkage, ridge regularization) so it may be inverted

    - 'Semi-parametric': still uses parametric distributions for significance testing, which can be problematic
